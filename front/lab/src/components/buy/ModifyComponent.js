          ...
          <div className="grid grid-cols-8 gap-3 w-1/2 mx-auto mt-2 p-2 text-xl shadow-set mb-5">
            ...
            <div className="col-start-6 col-span-2 mb-3">
              <div className="flex">
                ...
                <button className="text-base text-white bg-slate-300 p-2 rounded-md w-1/2 hover:bg-slate-400" onClick={() => moveToRead(buy.buyNo)}>취소하기</button>
              </div>
            </div>
