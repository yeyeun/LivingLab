          ...
          <div>
            ...
            <div className="py-5 text-sm font-regular text-gray-900 flex">
              ...
              <p className="ml-auto mr-2 flex flex-row">
                <img src={heartEmpty} width="20" alt="..."></img>
                <span className="mx-1">{tip.commHit}</span>
                <img src={replyIcon} width="20" alt="..."></img>
            ...
            {tip.uploadFileNames.map((imgFile, i) => (
              <img alt="tip" key={i} width={600} src={`${host}/api/community/tip/display/${imgFile}`} className="my-3" />
            ))}
            ...
            <div className="flex justify-center space-x-2 mt-4">
              <button type="button" className="bg-gray-400 text-white rounded-md text-sm px-1 py-0.5 hover:bg-gray-500 ml-1" onClick={() => moveToModify(commNo)}>
                수정하기
              </button>
              <button type="button" className="bg-gray-400 text-white rounded-md text-sm px-1 py-0.5 hover:bg-gray-500 ml-1" onClick={handleClickDelete}>
                삭제하기
              </button>
              <button type="button" className="bg-gray-400 text-white rounded-md text-sm px-1 py-0.5 hover:bg-gray-500 ml-1" onClick={() => moveToList()}>
                목록으로 이동
              </button>
            </div>
            <div>
