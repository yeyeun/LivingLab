          ...
          <aside id="info-area" className="w-[360px] col-span-1">
            <div id="content-container" className="sticky top-24">
              <div id="inner-content" className="w-90 p-8 bg-white shadow-md border border-gray-300 rounded-sm relative">
                <p className="flex-none text-gray-900 text-base leading-6 font-normal">{shareRoom.content}</p>
                <div id="buttons" className="flex items-center w-full mt-8">
                  ...
                  <div className="w-[77px] ml-2">
                    ...
                    <span className="mx-1">{shareRoom.hit}</span> */}
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="mt-[100px]">
            {loginState.id === shareRoom.userId && (
              <>
                <button
                  type="button"
                  className="ml-5 float-right inline-block rounded bg-blue-400 px-6 pb-2 pt-2.5 text-base font-medium leading-normal text-white shadow-md transition duration-150 ease-in-out hover:bg-blue-500 focus:bg-primary-accent-300 focus:shadow-primary-2 focus:outline-none focus:ring-0 active:bg-teal-600 motion-reduce:transition-none"
