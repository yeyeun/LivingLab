        ...
        <div className="flex items-center basis-auto text-xl font-semibold">
          ...
          <ul className="flex flex-row p-3 list-none me-auto">
            <li className="pr-10 pl-5">
              <Link to={'/'} className="menu-hover">
                홈
              </Link>
            </li>
            <li className="pr-10">
              <Link to={'/buy'} className="menu-hover">
                공동구매
              </Link>
            </li>
            <li className="pr-10">
              <Link to={'/team'} className="menu-hover">
                동네모임
              </Link>
            </li>
            <li className="pr-10">
              <Link to={'/market'} className="menu-hover">
                동네장터
              </Link>
            </li>
            <li className="pr-10">
            ...
            <li className="pr-10">
              <Link to={'/community/tip'} className="menu-hover">
                커뮤니티
              </Link>
            </li>
          </ul>
